class Strings{
  ...
  static String subscribeNow = "subscribe_now";
  static String noAccount = "no_account";
  ...
  static String orLoinWith = "or_login_with";
  static String termsAndConditions = "terms_and_conditions";
  static String signUp = "sign_up";
  static String enterDetailsSignUp = "enter_details_signup";
  static String signupNowAndStart = "signup_now_and_start";
